...
const Marquee: FC<MarqueeProps> = forwardRef(function Marquee(
  ...
  const calculateWidth = useCallback(() => {
    if (marqueeRef.current && containerRef.current) {
      ...
      let containerWidth = containerRect.height;
      let marqueeWidth = marqueeRect.height;
      ...
      return [
        ...
        <Fragment key={i}>
          {Children.map(children, (child) => {
            return (
              <div style={childStyle} className={s.child}>
                {child}
              </div>
            );
          })}
  ...
  return !isMounted ? null : (
    ...
    >
      ...
      >
        <div className={s.initialChildContainer} ref={marqueeRef}>
          {Children.map(children, (child) => {
            return (
              <div style={childStyle} className={s.child}>
                {child}
      ...
      <div className={s.marquee} style={marqueeStyle}>
